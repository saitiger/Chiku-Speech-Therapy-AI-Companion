...
const InteractiveScenario: React.FC<InteractiveScenarioProps> = ({ scenarioContent }) => {
  ...
  const handleSubmitCustomResponse = () => {
    if (customResponse.trim()) {
      ...
      const goodResponse = currentExchange.responseOptions.find(option => option.quality === "Good") || 
                          currentExchange.responseOptions[0];
            ...
            <div className="mt-6 p-4 bg-speech-light/20 rounded-lg">
              ...
              <div className="flex items-center gap-3">
                <Button
                  ...
                  className={`rounded-full p-3 w-12 h-12 ${isRecording ? 'bg-red-500 hover:bg-red-600' : 'bg-speech-purple hover:bg-speech-purple/80'}`}
                >
                ...
                <div className="flex-1">
                  {customResponse ? (
                    ...
                    <p className="text-speech-dark/70 text-sm">
              ...
              {customResponse && (
                <Button
                  ...
                  className="mt-3 bg-speech-purple hover:bg-speech-purple/90"
